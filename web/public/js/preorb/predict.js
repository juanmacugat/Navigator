var PLib = 
	{
		...
		indx: 0.0, iaz: 0.0, iel: 0.0, ma256: 0.0, isplat: 0.0, isplong: 0.0, Flags: 0.0,
		...
		Calc: function()
		{
			...
			PLib.irk = (PLib.sat_range).toFixed(6);
			PLib.isplat = (PLib.sat_lat).toFixed(6);
			PLib.isplong = (360.0 - PLib.sat_lon).toFixed(6);
			PLib.iaz = (PLib.sat_azi).toFixed(6);
			PLib.iel = Math.round(PLib.sat_ele);
			PLib.ma256 = (256.0 * (PLib.phase / PLib.twopi)).toFixed(6);
		...
		QuickFind: function(satname, tleLine1, tleLine2)
		{
			var satInfo = new Object();
			PLib.sat[0].name = satname;
			PLib.sat[0].line1 = tleLine1;
			PLib.sat[0].line2 = tleLine2;
